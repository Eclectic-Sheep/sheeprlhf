...
class SummarizationData(DataProcessor):
    ...
    def get_example_prompt(self) -> str:  # noqa: D102
        prompt = (
            ...
            "I'm really hoping that someone can help me figure out what's causing these problems and what "
            "I can do to fix them. I don't have a lot of experience with troubleshooting hardware issues, "
            "so any advice or guidance would be greatly appreciated! Does anyone have any "
